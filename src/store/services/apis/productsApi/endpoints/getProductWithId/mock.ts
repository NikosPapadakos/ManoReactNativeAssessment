import { ProductFromIdResponse } from '../../types'

export const MOCK_PRODUCT_RES: ProductFromIdResponse = {
  success: true,
  data: {
    id: 12199,
    ...
    categories: [
      {
        ...
        parent_category: {
          ...
          title: 'NAIJA FLAVOURS',
          category_type: 'normal',
          class_name: 'Category',
          created_at: '2022-08-23T12:23:35.337Z',
          images: [
            {
              id: 10851,
              sort_order: null,
              attachment_type: 'other',
              class_name: 'Attachment',
              created_at: '2022-08-30T10:25:24.579Z',
              thumbnail:
                'https://cdn.manoapp.com/variants/krbqf7xepsbchgx58qpayqd3nxsn/cfac2cf5e20fe7457efd3f809e7f27e58f4ea9095af3b17038d0c3ad02cc7e81',
              large:
                'https://cdn.manoapp.com/variants/krbqf7xepsbchgx58qpayqd3nxsn/591fe3429fa59bfe054d222d66110883129e394e673fe4d32f213228e05dd59e',
              small:
                'https://cdn.manoapp.com/variants/krbqf7xepsbchgx58qpayqd3nxsn/29a9bad9089cbe7b09bf93243050556c68653f44594116934458f7b3fef584f1',
              extra_small:
                'https://cdn.manoapp.com/variants/krbqf7xepsbchgx58qpayqd3nxsn/ea9a7d4c7468d9b785648f365f677f63cd0998f6c26a543d0fc3633ba5df015d',
              original: 'https://cdn.manoapp.com/krbqf7xepsbchgx58qpayqd3nxsn',
              extra_props: {
                identified: true,
              },
            },
  ...
  message: null,
  request_data: {
    started_at: '2024-05-17T03:33:26.725+00:00',
    ended_at: '2024-05-17T03:33:26.883+00:00',
  },
}
